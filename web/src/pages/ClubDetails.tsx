  ...
  return (
    <div>
      <button onClick={() => navigate('/clubs')} className="flex items-center text-forest-green hover:underline mb-8">
        <ArrowLeft className="w-4 h-4 mr-2" /> All Clubs
      </button>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex flex-col gap-4">
                {isAuthorized && (
                  ...
                  >
                    <Plus className="w-6 h-6 mr-2" /> Create Event
                  </Link>
                )}
                {isMember ? (
                  <div className="px-6 py-3 rounded-2xl font-bold flex items-center justify-center bg-sand border-2 border-sand border-opacity-50 text-earth-brown shadow-lg">
                    ...
                    <div className="flex flex-col items-start leading-tight">
                      <span className="text-[10px] uppercase tracking-widest opacity-70 font-black">Club Member</span>
                  ...
                  >
                    <UserPlus className="w-6 h-6 mr-2" /> {joining ? 'Joining...' : 'Join Club'}
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              {club.events && club.events.length > 0 ? (
                ...
                <div className="text-center py-16 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                  ...
                  <p className="text-gray-500">No events scheduled yet for this club.</p>
                </div>
              )}
            </div>
